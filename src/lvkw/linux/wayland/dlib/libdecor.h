 ...
 * to ensure __typeof__() or explicit types can resolve.
 */
struct libdecor;
...
#define libdecor_frame_set_min_content_size(...) \
  lvkw_lib_decor.frame_set_min_content_size(__VA_ARGS__)
#define libdecor_frame_set_max_content_size(...) \
  lvkw_lib_decor.frame_set_max_content_size(__VA_ARGS__)
#define libdecor_frame_get_min_content_size(...) \
  lvkw_lib_decor.frame_get_min_content_size(__VA_ARGS__)
#define libdecor_frame_get_max_content_size(...) \
  lvkw_lib_decor.frame_get_max_content_size(__VA_ARGS__)
...
#define libdecor_frame_translate_coordinate(...) \
  lvkw_lib_decor.frame_translate_coordinate(__VA_ARGS__)
...
#define libdecor_configuration_get_content_size(...) \
  lvkw_lib_decor.configuration_get_content_size(__VA_ARGS__)
#define libdecor_configuration_get_window_state(...) \
  lvkw_lib_decor.configuration_get_window_state(__VA_ARGS__)
#define libdecor_dispatch(...) lvkw_lib_decor.dispatch(__VA_ARGS__)
