...
static void _libdecor_frame_handle_configure(struct libdecor_frame *frame, struct libdecor_configuration *configuration,
  ...
  LVKW_WND_ASSUME(user_data, window != NULL, "Window handle must not be NULL in libdecor configure handler");
...
static void _libdecor_frame_handle_close(struct libdecor_frame *frame, void *user_data) {
  ...
  LVKW_WND_ASSUME(user_data, window != NULL, "Window handle must not be NULL in libdecor close handler");
...
static void _libdecor_frame_handle_commit(struct libdecor_frame *frame, void *user_data) {
  ...
  LVKW_WND_ASSUME(user_data, window != NULL, "Window handle must not be NULL in libdecor commit handler");

  wl_surface_commit(window->wl.surface);
}

static void _libdecor_frame_handle_dismiss_popup(struct libdecor_frame *frame, const char *seat_name, void *user_data) {
}
