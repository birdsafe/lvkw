...
LVKW_Status lvkw_ctx_getMonitors_Win32(LVKW_Context *ctx, LVKW_MonitorInfo *out_monitors, uint32_t *count);
LVKW_Status lvkw_ctx_getMonitorModes_Win32(LVKW_Context *ctx, LVKW_MonitorId monitor,
